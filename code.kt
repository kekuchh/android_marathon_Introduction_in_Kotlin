...
fun sendMessageToClient(
    ...
    email?.let{it->mailer.sendMessage(it, message)}
}
...
operator fun MyDate.plus(timeIntervals: TimeIntervals) = addTimeIntervals(timeIntervals.timeInterval, timeIntervals.amount)
